export var initialQuestions = [{
  ...
  guidance: {
    ...
    tips: ['Renseignez le nom officiel ou celui que vous souhaitez tester auprès des parties prenantes.', 'Si un nom de code interne existe, ajoutez-le entre parenthèses pour faciliter le suivi.']
  },
  showcase: {
    sections: ['hero'],
  ...
  guidance: {
    ...
    tips: ['Utilisez un verbe d’action qui évoque le résultat attendu.', 'Préférez un ton conversationnel : adressez-vous directement à votre audience.']
  },
  showcase: {
    sections: ['hero'],
  ...
  options: ['Grand public / clients finaux', 'Professionnels ou experts métiers', 'Décideurs internes / sponsors', 'Investisseurs', 'Partenaires ou prescripteurs'],
  required: true,
  conditions: [],
  conditionLogic: 'all',
  guidance: {
    ...
    tips: ['Sélectionnez plusieurs options si votre pitch est multicanal.', 'Ajoutez des précisions dans vos notes internes si certains personae doivent recevoir un message dédié.']
  },
  showcase: {
    sections: ['hero'],
  ...
  guidance: {
    ...
    tips: ['Utilisez une ligne par pain point pour faciliter la lecture.', 'Décrivez la situation vécue plutôt que la solution souhaitée.']
  },
  showcase: {
    sections: ['problem'],
  ...
  guidance: {
    ...
    tips: ['Structurez en 2-3 phrases : quoi, pour qui, comment.', 'Évitez le vocabulaire interne : imaginez que vous présentez le concept à un prospect.']
  },
  showcase: {
    sections: ['solution'],
  ...
  guidance: {
    ...
    tips: ['Rédigez une phrase par bénéfice, orientée résultat (“Gain de 2h par semaine”).', 'Priorisez les bénéfices les plus différenciants pour votre audience.']
  },
  showcase: {
    sections: ['solution'],
  ...
  guidance: {
    ...
    tips: ['Comparez-vous à un comportement ou à une solution existante plutôt qu’à un concurrent direct.', 'Appuyez-vous sur un bénéfice mesurable ou une expérience utilisateur plus fluide.']
  },
  showcase: {
    sections: ['solution'],
  ...
  guidance: {
    ...
    tips: ['Indiquez la date à laquelle vous souhaitez lancer la production des supports.', 'Mettez à jour la date si la préparation démarre plus tôt ou plus tard que prévu.']
  },
  showcase: {
    sections: ['timeline'],
  ...
  guidance: {
    ...
    tips: ['Renseignez la première date de mise en avant (événement, publication, annonce).', 'Si la date n’est pas figée, indiquez l’hypothèse la plus réaliste pour planifier les ressources.']
  },
  showcase: {
    sections: ['timeline'],
  ...
  guidance: {
    ...
    tips: ['Indiquez prénom, nom et rôle.', 'Ajoutez si besoin un canal de contact (LinkedIn, e-mail) dans vos notes internes.']
  },
  showcase: {
    sections: ['team'],
  ...
  guidance: {
    ...
    tips: ['Mentionnez pour chaque personne le rôle ou l’expertise apportée.', 'Incluez éventuellement les partenaires ou experts externes essentiels.']
  },
  showcase: {
    sections: ['team'],
