export var initialRules = [{
  ...
  teams: ['story'],
  questions: {
    story: ['Le slogan résume-t-il la promesse en moins de 10 mots ?', 'La proposition de valeur précise-t-elle bien le public, le problème et le bénéfice clé ?', 'Les pain points sont-ils formulés dans le langage de l’audience ?']
  },
  risks: [{
  ...
  conditions: [{
    ...
    operator: 'contains',
    value: 'Grand public / clients finaux'
  }],
  conditionLogic: 'all',
  teams: ['story', 'press'],
  questions: {
    story: ['Le ton est-il inclusif et dépourvu de jargon ?', 'Une illustration forte est-elle identifiée pour soutenir le message ?'],
    press: ['Les éléments de preuve sont-ils sourcés et prêts à être partagés ?', 'Un plan de diffusion média ou social est-il esquissé ?']
  },
  risks: [{
  ...
  questions: {
    growth: ['Les chiffres de marché et de traction sont-ils consolidés dans un format partageable ?', "Le plan d'impact financier ou d'adoption est-il prêt à être commenté ?"],
    partners: ['Les synergies ou partenariats stratégiques sont-ils clairement identifiés ?', 'Les besoins de financement ou de ressources sont-ils explicites ?']
  },
  risks: [{
  ...
  conditions: [{
    question: 'targetAudience',
    operator: 'contains',
    value: 'Partenaires ou prescripteurs'
  }],
  conditionLogic: 'all',
  teams: ['partners', 'product'],
  questions: {
    partners: ['Le rôle attendu des partenaires est-il décrit clairement ?', 'Les bénéfices mutuels sont-ils tangibles et chiffrés ?'],
    product: ['Une démonstration spécifique partenaires est-elle prévue ?', 'Les ressources (kits, argumentaires) sont-elles identifiées ?']
  },
  risks: [{
  ...
  questions: {
    story: ['Le rétroplanning de production des contenus est-il aligné avec la date de lancement ?'],
    product: ['Les démonstrations et preuves produit sont-elles planifiées dans le calendrier ?'],
    growth: ['Les KPI de suivi post-lancement sont-ils définis avant la diffusion ?']
  },
  risks: [{
